...
public class qpoint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qpoint);
        ...
        btncall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:0703351697"));
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openWebPage("https://qpointentertainment.com/");
            }
        });
    }
    ...
    private void openWebPage(String url) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(qpoint.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
