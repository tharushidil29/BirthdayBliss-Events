...
public class CakeShop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cake_shop);
        ...
        btncall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:0721251697"));
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openWebPage("https://www.thecakeshop.lk/");
            }
        });
    }
    ...
    private void openWebPage(String url) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CakeShop.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
